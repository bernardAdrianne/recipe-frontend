<script lang="ts">
  ...
  onMount(async () => {
    try {
      const res = await fetch("https://airecipe-backend-2.onrender.com/user/", {
        method: "GET",
        credentials: "include",
        cache: "no-store",
      });
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const uploadRes = await fetch("https://airecipe-backend-2.onrender.com/user/upload-profile-picture", {
          method: "POST",
          body: formData,
          credentials: "include",
        });
      ...
      const res = await fetch("https://airecipe-backend-2.onrender.com/user/editprofile", {
        method: "PUT",
        headers: {
