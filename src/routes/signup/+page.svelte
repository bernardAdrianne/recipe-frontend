<script lang="ts">
  ...
  let activeTab: 'signin' | 'signup' = 'signup';
  let hovered: 'signin' | 'signup' | null = null;
...
<div class="flex justify-center mb-6">
  <div class="relative flex bg-gray-100 rounded-md p-2 shadow-inner w-full max-w-xl overflow-hidden">
    ...
    <div
      class="
        ...
        pointer-events-none
      "
      class:translate-x-full={(hovered ?? activeTab) === 'signup'}
    ></div>
    ...
    <button
      ...
      "
      class:text-black={(hovered ?? activeTab) === 'signin'}
      class:text-gray-700={(hovered ?? activeTab) !== 'signin'}
    >
    ...
    <button
      ...
      class="
        ...
        transition-colors duration-300
      "
      class:text-black={(hovered ?? activeTab) === 'signup'}
      class:text-gray-700={(hovered ?? activeTab) !== 'signup'}
    >
      <UserPlus size="16" />
      Sign Up
    </button>
